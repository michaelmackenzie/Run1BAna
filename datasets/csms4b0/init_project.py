...
#------------------------------------------------------------------------------
        self.add_dataset(Dataset('dig.mu2e.csms4b0s41r0000.Run1BAna.art','csms4b0s41r0000','local'));
    ...
    def __init__(self,idsid=None):
        ...
        ProjectBase.__init__(self,project='Run1BAna',family_id='csms4b0',idsid=idsid);
        self.init_datasets();
...
#------------------------------------------------------------------------------
        s                            = self.new_stage('s5');
        job                          = s.new_job('reco_trig_nt','csms4b0s41r0000'); #idsid);
