...
#------------------------------------------------------------------------------
        self.add_dataset(Dataset('dig.mu2e.fgam40b1s41r0000.Run1BAna.art','fgam40b1s41r0000','local'));
    ...
    def __init__(self,idsid=None):
        ...
        ProjectBase.__init__(self,project='Run1BAna',family_id='fgam40b1',idsid=idsid);
        self.init_datasets();
...
#------------------------------------------------------------------------------
        s                            = self.new_stage('s5');
        job                          = s.new_job('reco_trig_nt','fgam40b1s41r0000'); #idsid);
